...
export const builderConfig: BuilderConfig = {
  designTokens: {
    colors: [
      ...
      // Special Use Colors
      { name: "Action Special Use", value: "var(--color-action-special-use)" },
      {
      ...
      { name: "Text Quaternary", value: "var(--color-text-quaternary)" },
      { name: "Text Accent", value: "var(--color-text-accent)" },
      { name: "Text Complementary", value: "var(--color-text-complementary)" },
      ...
      { name: "Icon Complementary", value: "var(--color-icon-complementary)" },
      { name: "Icon Inverse", value: "var(--color-icon-inverse)" },
      { name: "Icon Disabled", value: "var(--color-icon-disabled)" },

      // Data Visualization Colors
      { name: "Data Primary", value: "var(--color-data-primary)" },
      { name: "Data Secondary", value: "var(--color-data-secondary)" },
      { name: "Data Tertiary", value: "var(--color-data-tertiary)" },
      { name: "Data Positive", value: "var(--color-data-positive)" },
      { name: "Data Negative", value: "var(--color-data-negative)" },
      { name: "Data Neutral", value: "var(--color-data-neutral)" },
      { name: "Data Attention", value: "var(--color-data-attention)" },

      // UI State Colors
      { name: "UI Primary", value: "var(--color-ui-primary)" },
      { name: "UI Primary Hover", value: "var(--color-ui-primary-hover)" },
      { name: "UI Primary Active", value: "var(--color-ui-primary-active)" },
      { name: "UI Secondary", value: "var(--color-ui-secondary)" },
      { name: "UI Tertiary", value: "var(--color-ui-tertiary)" },
      { name: "UI Positive", value: "var(--color-ui-positive)" },
      { name: "UI Negative", value: "var(--color-ui-negative)" },
      { name: "UI Attention", value: "var(--color-ui-attention)" },
      { name: "UI Info", value: "var(--color-ui-info)" },
      { name: "UI Neutral", value: "var(--color-ui-neutral)" },
    ],

    spacing: [
      // Component Spacing
      { name: "Component Gap XS", value: "var(--space-component-gap-x-small)" },
      {
      ...
      { name: "Column Gap Medium", value: "var(--space-column-gap-medium)" },
      { name: "Column Gap Large", value: "var(--space-column-gap-large)" },
    ...
    fontSizes: [
      ...
      // Component Text
      { name: "Component XS", value: "var(--font-size-component-x-small)" },
      { name: "Component Small", value: "var(--font-size-component-small)" },
      { name: "Component Medium", value: "var(--font-size-component-medium)" },
      { name: "Component Large", value: "var(--font-size-component-large)" },
      { name: "Component XL", value: "var(--font-size-component-x-large)" },
    ...
    fontWeights: [
      ...
      { name: "Component Bold", value: "var(--font-weight-component-bold)" },
    ],

    fontFamilies: [
      { name: "Body", value: "var(--font-family-body)" },
      { name: "Heading", value: "var(--font-family-heading)" },
      { name: "Display", value: "var(--font-family-display)" },
      { name: "Component", value: "var(--font-family-component)" },
    ],
    ...
    shadows: [
      ...
      {
        name: "Level 1",
        value: "var(--elevation-level-1) var(--color-shadow)",
      },
      {
        name: "Level 2",
        value: "var(--elevation-level-2) var(--color-shadow)",
      },
      {
        name: "Level 3",
        value: "var(--elevation-level-3) var(--color-shadow)",
      },
      {
        name: "Level 4",
        value: "var(--elevation-level-4) var(--color-shadow)",
      },
    ],
  },
